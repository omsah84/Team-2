...
export default function FeaturesSection() {
  const features = [
    {
      ...
      description:
        "Effortlessly track and resolve project issues using our intuitive project management tools.",
    ...
    },
    {
      ...
      description:
        "Capture professional-grade photos in an instant with our advanced AI-powered camera technology.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-3 dark:border-neutral-800",
    },
    {
      title: "Explore Our AI on YouTube",
      description:
        "Get a deeper understanding of our AI solutions through detailed tutorials and demonstrations on YouTube.",
    ...
    },
    {
      ...
      description:
        "Deploy your models in seconds with our fast and reliable cloud infrastructure, powered by the latest technologies.",
      skeleton: <SkeletonOne />,
  ...
  return (
    <div className="relative z-20 py-10 lg:py-10 max-w-7xl mx-auto bg-black">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          Unlock possibilities with our innovative solutions. From web
          development to AI, we transform your business with precision.
        </p>
      </div>
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full  p-5  mx-auto bg-black dark:bg-neutral-900 shadow-2xl group h-[400px]">
  ...
  return (
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-[400px] my-10 flex-col space-y-2  relative">
          {/* TODO */}
